...
1.  Work with your IT admin/organization to discuss your business processes and
    ...
    permissions, groups, and security. More information: [ALM environment strategy](https://learn.microsoft.com/en-us/power-platform/alm/environment-strategy-alm)
...
More information: [Solution concepts](https://learn.microsoft.com/en-us/power-platform/alm/solution-concepts-alm)
...
## References
  - [https://learn.microsoft.com/en-us/power-platform/alm/citizen-dev-alm](https://learn.microsoft.com/en-us/power-platform/alm/citizen-dev-alm)
